 ...
 * 
 */
public abstract class AbstractAndroidBusMembersRegistry extends AbstractCommonBusPersistable
	implements IRegistry {

    protected IAndroidBus androidBus;

    public AbstractAndroidBusMembersRegistry(IAndroidBus androidBus, Context context) {
	super(context);
	...
	sqliteMngr.open();
	try {
	    String busMemberID = sqliteMngr.queryBusMemberIDByGroundingID(registryID);
    ...
    protected abstract BusMember createBusMember(BusMemberRowDB registryServicesRowDB);
