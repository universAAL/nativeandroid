 ...
 *
 */
package org.universAAL.middleware.android.common.xml;
...
public class CommonXmlParserUtils {
    ...
    public static Node getSingleChildNode(Node node, String elementName, boolean isMandatory) {
	Node foundNode = null;
	...
	String attributeValue = foundAttribute != null ? foundAttribute.getNodeValue() : null;
