...
public class ActionXmlObj implements Serializable {
	...
	androidAction = CommonXmlParserUtils.getAttributeValueAsString(actionNode,
		IServiceRequestGroundingXmlConstants.ACTION_ATTRIBUTE_ANDROID_ACTION);
	androidCategory = CommonXmlParserUtils.getAttributeValueAsString(actionNode,
		IServiceRequestGroundingXmlConstants.ACTION_ATTRIBUTE_ANDROID_CATEGORY);
	serviceJavaClass = CommonXmlParserUtils.getAttributeValueAsString(actionNode,
		IServiceRequestGroundingXmlConstants.ACTION_ATTRIBUTE_SERVICE_JAVA_CLASS);
	androidReplyToAction = CommonXmlParserUtils.getAttributeValueAsString(actionNode,
		IServiceRequestGroundingXmlConstants.ACTION_ATTRIBUTE_REPLY_TO_ACTION, false);
	androidReplyToCategory = CommonXmlParserUtils.getAttributeValueAsString(actionNode,
		IServiceRequestGroundingXmlConstants.ACTION_ATTRIBUTE_REPLY_TO_CATEGORY, false);
	...
	Node valueFiltersNode = CommonXmlParserUtils.getSingleChildNode(actionNode,
	...
	List<Node> valueFilterChildrenList = CommonXmlParserUtils.getChildNodes(valueFiltersNode,
	...
	Node requiredOutputsNode = CommonXmlParserUtils.getSingleChildNode(actionNode,
	...
	List<Node> requiredOutputChildrenList = CommonXmlParserUtils.getChildNodes(
		requiredOutputsNode, IServiceRequestGroundingXmlConstants.REQUIRED_OUTPUT_ELEMENT);
	for (Node curRequiredOutputChild : requiredOutputChildrenList) {
	    requiredOutputs.add(new RequiredOutputXmlObj(curRequiredOutputChild));
	}
    }

    private void populateChangeEffects(Node operationNode) {
	Node changeEffectsNode = CommonXmlParserUtils.getSingleChildNode(operationNode,
	...
	List<Node> changeEffectChildrenList = CommonXmlParserUtils.getChildNodes(changeEffectsNode,
