 ...
 * 
 */
public class NoticePeerBussesActionInvocation extends AbstractActionInvocation {

    private static final String TAG = NoticePeerBussesActionInvocation.class.getCanonicalName();

    public NoticePeerBussesActionInvocation(Service<RemoteDevice, RemoteService> service,
	    String peerID, String bussesNames) {
	super(service, Action.NOTICE_PEER_BUSSES.getName());
