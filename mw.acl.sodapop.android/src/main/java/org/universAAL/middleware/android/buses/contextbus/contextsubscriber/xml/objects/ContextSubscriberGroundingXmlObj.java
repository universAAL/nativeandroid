...
public class ContextSubscriberGroundingXmlObj extends OntologiesContainedXml {
    ...
    public static ContextSubscriberGroundingXmlObj deserialize(byte[] objAsBytesArr) {
	return (ContextSubscriberGroundingXmlObj) SerializeUtils.deserializeObject(objAsBytesArr);
    }
	...
	Node actionNode = CommonXmlParserUtils.getSingleChildNode(contextSubscriberNode,
