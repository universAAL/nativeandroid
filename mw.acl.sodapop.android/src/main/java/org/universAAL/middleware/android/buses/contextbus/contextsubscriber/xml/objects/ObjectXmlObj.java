...
public class ObjectXmlObj implements Serializable {
	...
	androidExtraParameter = CommonXmlParserUtils.getAttributeValueAsString(objectNode,
		IContextSubscriberGroundingXmlConstants.OBJECT_ATTRIBUTE_ANDROID_EXTRA_PARAM);
	androidExtraParameterJavaClass = CommonXmlParserUtils
		.getAttributeValueAsString(
			objectNode,
			IContextSubscriberGroundingXmlConstants.OBJECT_ATTRIBUTE_ANDROID_EXTRA_PARAM_JAVA_CLASS);
    }
