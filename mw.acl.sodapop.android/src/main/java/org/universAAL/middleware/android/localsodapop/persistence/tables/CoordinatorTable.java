...
public class CoordinatorTable {
    ...
    // Columns
    public static final String COLUMN_ID_PK = "_COORDINATOR_ID_PK";
    public static final String COLUMN_COORDINATOR_PEER_ID = "PEER_ID";

    // Peers table creation
    public static final String TABLE_CREATE = "create table if not exists " + TABLE_NAME + "( "
	    + COLUMN_ID_PK + " " + ISqlConstants.AUTO_INCREMENT_PK + ", "
	    + COLUMN_COORDINATOR_PEER_ID + " VARCHAR(50) " + ISqlConstants.NOT_NULL_COLUMN + ");";
}
