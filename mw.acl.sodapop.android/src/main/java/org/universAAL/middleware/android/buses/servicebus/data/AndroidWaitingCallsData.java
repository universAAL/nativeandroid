 ...
 * 
 */
public class AndroidWaitingCallsData extends AbstractAndroidServiceBusPersistable implements
	IWaitingCallsData {
	...
	sqliteMngr.open();
	try {
	    sqliteMngr.addWaitingCall(callID, actionName, replyToAction, replyToCategory);
	} finally {
	    sqliteMngr.close();
	}
    }
