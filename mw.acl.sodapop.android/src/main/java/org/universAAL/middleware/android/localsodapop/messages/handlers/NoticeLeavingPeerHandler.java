 ...
 * 
 */
public class NoticeLeavingPeerHandler extends AbstractMessagePersistableHandler {

    @Override
    protected void privateHandleMessage(IMessage message, AbstractSodaPopAndroidImpl sodaPop) {
	// Cast it to notice leaving peer message
	NoticeLeavingPeerMessage noticeLeavingPeerMessage = (NoticeLeavingPeerMessage) message;

	sodaPop.noticeLeavePeer(noticeLeavingPeerMessage.getPeerID());
    }
