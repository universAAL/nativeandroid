 ...
 * 
 */
public class NoticePeerBussesHandler extends AbstractMessagePersistableHandler {

    @Override
    protected void privateHandleMessage(IMessage message, AbstractSodaPopAndroidImpl sodaPop) {
	// Cast it to notice peer busses message
	NoticePeerBussesMessage noticePeerBussesMessage = (NoticePeerBussesMessage) message;

	sodaPop.noticePeerBusses(noticePeerBussesMessage.getPeerID(),
		noticePeerBussesMessage.getBusNames());
    }
