 ...
 * 
 */
public interface IWaitingCallsData {

    void addWaitingCall(String callID, String actionName, String replyToAction,
	    String replyToCategory);

    WaitingCallRowDB getAndRemoveWaitingCall(String callID);
