...
public class ServiceBusMessageFactory {
    ...
    private static final String TAG = ServiceBusMessageFactory.class.getCanonicalName();
	...
	case INITIALIZE:
	    ...
	    break;
	case REGISTER:
	    message = new RegisterServicesMessage(context, intent);
	    break;
	case UNREGISTER:
	...
	case PROCESS_BUS_MESSAGE_RSP:
	    message = new ProcessBusMessageResponse(context, intent);
	    break;
	case SERVICE_REQUEST:
	    message = new ServiceRequestMessage(context, intent);
	    break;
	}
