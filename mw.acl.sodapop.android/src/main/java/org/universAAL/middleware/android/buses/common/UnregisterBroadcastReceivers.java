...
public class UnregisterBroadcastReceivers {
    ...
    public static void unregisterReceiver(String androidAction, String androidContext,
	    Context context) {
	...
	intent.putExtra(IAndroidSodaPop.EXTRAS_KEY_UNREGISTER_BROADCAST_RECEIVER, true);
