 ...
 * 
 */
public class ReplyPeerBussesHandler extends AbstractMessagePersistableHandler {

    @Override
    protected void privateHandleMessage(IMessage message, AbstractSodaPopAndroidImpl sodaPop) {
	// Cast it to reply peer busses message
	ReplyPeerBussesMessage replyPeerBussesMessage = (ReplyPeerBussesMessage) message;

	sodaPop.replyPeerBusses(replyPeerBussesMessage.getPeerID(),
		replyPeerBussesMessage.getBusNames());
    }
}
