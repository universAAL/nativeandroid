...
public class ProcessBusMessageResponse extends AbstractMessage {
	...
	return extractStringFromExtras(IAndroidSodaPop.EXTRAS_KEY_MESSAGE_ID_IN_REPLY);
    }

    protected String extractServiceCalleeIDFromExtras() {
	return extractStringFromExtras(IAndroidSodaPop.EXTRAS_KEY_SERVICE_CALLEE_ID);
    }

    protected String extractOperationNameFromExtras() {
	return extractStringFromExtras(IAndroidSodaPop.EXTRAS_KEY_OPERATION_NAME);
    }

    protected String extractReplyToFromExtras() {
	return extractStringFromExtras(IAndroidSodaPop.EXTRAS_KEY_REPLY_TO);
    }
}
