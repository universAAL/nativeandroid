 ...
 * 
 */
public abstract class AbstractMessagePersistableHandler extends AbstractMessageHandler {
	...
	// required data
	AbstractSodaPopAndroidImpl sodaPop = SodaPopAndroidFactory.createAndroidSodaPop(
		message.getContext(), message.getProtocol(), sodaPopPeersSQLiteMngr);
    ...
    protected AndroidServiceBus createServiceBus(IMessage message,
	    AbstractSodaPopAndroidImpl sodaPop) {
	// Get the context
    ...
    protected AndroidContextBus createContextBus(IMessage message,
	    AbstractSodaPopAndroidImpl sodaPop) {
	// Get the context
	Context context = message.getContext();
