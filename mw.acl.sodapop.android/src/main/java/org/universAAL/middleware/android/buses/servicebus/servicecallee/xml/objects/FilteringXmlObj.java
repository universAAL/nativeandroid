...
public class FilteringXmlObj implements Serializable {
	...
	classURI = CommonXmlParserUtils.getAttributeValueAsString(filteringNode,
		IServiceGroundingXmlConstants.FILTERING_ATTRIBUTE_CLASS_URI);
	minCardinality = CommonXmlParserUtils.getAttributeValueAsInt(filteringNode,
		IServiceGroundingXmlConstants.FILTERING_ATTRIBUTE_MIN_CARDINALITY);
	maxCardinality = CommonXmlParserUtils.getAttributeValueAsInt(filteringNode,
