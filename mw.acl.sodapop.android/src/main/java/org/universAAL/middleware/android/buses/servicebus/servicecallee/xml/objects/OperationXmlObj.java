...
public class OperationXmlObj implements Serializable {
	...
	androidAction = CommonXmlParserUtils.getAttributeValueAsString(operationNode,
		IServiceGroundingXmlConstants.OPERATION_ATTRIBUTE_ANDROID_ACTION);
	androidCategory = CommonXmlParserUtils.getAttributeValueAsString(operationNode,
		IServiceGroundingXmlConstants.OPERATION_ATTRIBUTE_ANDROID_CATEGORY);
	androidReplyToAction = CommonXmlParserUtils.getAttributeValueAsString(operationNode,
		IServiceGroundingXmlConstants.OPERATION_ATTRIBUTE_REPLY_TO_ACTION, false);
	androidReplyToCategory = CommonXmlParserUtils.getAttributeValueAsString(operationNode,
		IServiceGroundingXmlConstants.OPERATION_ATTRIBUTE_REPLY_TO_CATEGORY, false);
	...
	// Get the inputs node
	Node inputsNode = CommonXmlParserUtils.getSingleChildNode(operationNode,
	...
	List<Node> inputChildrenList = CommonXmlParserUtils.getChildNodes(inputsNode,
	...
	Node outputsNode = CommonXmlParserUtils.getSingleChildNode(operationNode,
		IServiceGroundingXmlConstants.OUTPUTS_ELEMENT);
	...
	List<Node> outputChildrenList = CommonXmlParserUtils.getChildNodes(outputsNode,
		IServiceGroundingXmlConstants.OUTPUT_ELEMENT);
