 ...
 * 
 */
public class ServiceBusService extends AbstractAndroidBusService {

	private final static String TAG = ServiceBusService.class
			.getCanonicalName();
	...
	protected void privateOnStart(Intent intent, int startId) {
		...
		// Create the handler
		IMessageHandler handler = ServiceBusHandlerFactory.createHandler(
