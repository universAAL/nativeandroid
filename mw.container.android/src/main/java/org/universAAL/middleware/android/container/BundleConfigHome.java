...
//TODO: Change name to AndroidConfigHome
/**
...
public class BundleConfigHome extends ModuleConfigHome {
	 ...
	 */
	public static final String uAAL_CONF_ROOT_DIR = "/data/felix/configurations/etc/";
	...
	public BundleConfigHome(String id) {
		this(uAAL_CONF_ROOT_DIR, id);
	}

	public BundleConfigHome(String confHome, String id) {
		this.confHome = new File(Environment.getExternalStorageDirectory()
				.getPath() + uAAL_CONF_ROOT_DIR, id);
	...
	public File getPropFile(String nameWithoutExtension) {
		return new File(Environment.getExternalStorageDirectory().getPath(),
				uAAL_CONF_ROOT_DIR + nameWithoutExtension + ".properties");
	}
}
