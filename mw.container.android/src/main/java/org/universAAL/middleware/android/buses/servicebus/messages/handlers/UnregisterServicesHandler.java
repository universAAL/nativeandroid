 ...
 * 
 */
public class UnregisterServicesHandler extends
		AbstractMessagePersistableHandler {

	public UnregisterServicesHandler(ModulesCommWrapper wrapper) {
		super(wrapper);
	}
	...
	protected void privateHandleMessage(IMessage message/*
		...
		// Unregister
		androidServiceBus.unregisterByPackageName(unregisterServicesMessage
				.getPackageName());
	}
}
