...
public class ContextEventPatternsTable {
	...
	public static final String TABLE_CREATE = "create table if not exists "
			+ TABLE_NAME + "( " + COLUMN_CONTEXT_EVENT_PAT_ID_PK + " "
			+ ISqlConstants.AUTO_INCREMENT_PK + ", "
			+ COLUMN_CONTEXT_EVENT_CONTENT + " VARCHAR(200) "
			+ ISqlConstants.NOT_NULL_COLUMN + ", " + COLUMN_CALLED_PEERS_FK
			+ " integer, " + "FOREIGN KEY (" + COLUMN_CALLED_PEERS_FK
			+ ") REFERENCES " + CalledPeersTable.TABLE_NAME + " ("
