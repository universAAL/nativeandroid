...
public class ContextRequestsMngr {
	...
	private final static String TAG = ContextRequestsMngr.class
			.getCanonicalName();

	public static void registerToContextPublisherRequestGroundingActions(
			String publisherID,
	...
	private static BroadcastReceiver registerReceiver(String publisherID,
			ActionXmlObj action, Context context) {

		// Initiate the receiver
		BroadcastReceiver receiver = new ContextPublisherRequestBroadcastReceiver(
				publisherID, action.getAndroidAction());
		...
		Log.d(TAG,
				"A registration to receiver for ContextPublisher has been performed: Action ["
