 ...
 */
public class AndroidRefreshAALSpaceThread implements Runnable {
	private static final String TAG = "AndroidRefreshAALSpaceThread";
    ModuleContext moduleContext;
    AALSpaceManager aalSpaceManager;
    AndroidControlBroker controlBroker;

    public AndroidRefreshAALSpaceThread(ModuleContext moduleContext) {
	...
	Object o1 = moduleContext.getContainer().fetchSharedObject(
		moduleContext, new Object[] { AndroidControlBroker.class.getName() });
	if (o != null && o1 != null) {
	    try {
		aalSpaceManager = (AALSpaceManager) o;
		controlBroker = (AndroidControlBroker) o1;
		...
		Log.e(TAG, "Error during AAL Space refresh" ,e);
	    }
