...
public class ServiceBusSQLiteHelper extends AbstractCommonBusSQLiteHelper { // SQLiteOpenHelper
	...
	private static final String[] sqlCommandsOnCreation = new String[] {
			...
			LocalServicesIndexTable.TABLE_CREATE,
			LocalServiceSearchResultsTable.TABLE_CREATE,
			ServiceProfileTable.TABLE_CREATE,
			LocalWaitingCallerTable.TABLE_CREATE, WaitingCallTable.TABLE_CREATE };
