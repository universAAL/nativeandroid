...
public class WaitingCallTable {
    ...
    public static final String TABLE_CREATE = "create table if not exists " + TABLE_NAME + "( "
	    + COLUMN_ID_PK + " " + ISqlConstants.AUTO_INCREMENT_PK + ", " + COLUMN_CALL_ID
	    + " VARCHAR(50) UNIQUE " + ISqlConstants.NOT_NULL_COLUMN + ", " + COLUMN_ACTION_NAME
	    + " VARCHAR(50) " + ISqlConstants.NOT_NULL_COLUMN + ", " + COLUMN_REPLY_TO_ACTION
	    + " VARCHAR(50) " + ISqlConstants.NOT_NULL_COLUMN + ", " + COLUMN_REPLY_TO_CATEGORY
	    + " VARCHAR(50) " + ISqlConstants.NOT_NULL_COLUMN + ");";

    public static final String[] allColumns = new String[] { COLUMN_CALL_ID, COLUMN_ACTION_NAME,
	    COLUMN_REPLY_TO_ACTION, COLUMN_REPLY_TO_CATEGORY };
}
