 ...
 * 
 */
public class UnregisterContextsHandler extends AbstractMessagePersistableHandler {
	...
	// Unregister
	androidContextBus.unregisterByPackageName(unregisterServicesMessage.getPackageName());
    }
}
