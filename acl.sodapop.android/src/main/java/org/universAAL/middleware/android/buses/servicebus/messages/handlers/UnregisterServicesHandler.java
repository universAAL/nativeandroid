 ...
 * 
 */
public class UnregisterServicesHandler extends AbstractMessagePersistableHandler {
	...
	// Unregister
	androidServiceBus.unregisterByPackageName(unregisterServicesMessage.getPackageName());
    }
}
