/*
 * This is a copy of org.apache.xerces.jaxp.datatype.DatatypeFactoryImpl with 
 * the only change - the package name changed to org.universAAL.middleware.android.common.datafactory 
 * It is copied since this type is missing on Android.
 * Retrieved from 
 * http://svn.apache.org/repos/asf/xerces/java/tags/Xerces-J_2_9_1/src/org/apache/xerces/jaxp/datatype/DatatypeFactoryImpl.java
 * on 05.05.2012
 */
...
package org.universAAL.middleware.android.common.datafactory;
 ...
 * <code>javax.xml.datatype.DatatypeFactory</code>", exists, a class with the
 * name of the property's value is instantiated. Any Exception thrown during the
 ...
 * {@link java.util.Properties} <code>Object</code>. The <code>Properties</code>
 * <code>Object </code> is then queried for the property as documented in the
 * prior step and processed as documented in the prior step.</li>
 * <li>
 * The services resolution mechanism is used, e.g.
 * <code>META-INF/services/java.xml.datatype.DatatypeFactory</code>. Any
 * Exception thrown during the instantiation process is wrapped as a
 * {@link DatatypeConfigurationException}.</li>
 * <li>
 * The final mechanism is to attempt to instantiate the <code>Class</code>
 * specified by {@link #DATATYPEFACTORY_IMPLEMENTATION_CLASS}, "
 * <code>javax.xml.datatype.DatatypeFactoryImpl</code>". Any Exception thrown
...
public class DatatypeFactoryImpl extends DatatypeFactory {
     ...
     * </p>
     * <blockquote> duration represents a duration of time. The value space of
     ...
     * in Section 5.5.3.2 of [ISO 8601], respectively. These components are
     * ordered in their significance by their order of appearance i.e. as year,
     * month, day, hour, minute, and second. </blockquote>
     * <p>
     ...
     * {@link UnsupportedOperationException} will be thrown with a message
     ...
     * created {@link Duration}. The values conform to and are defined by:
     * </p>
     * <ul>
     * <li>ISO 8601:2000(E) Section 5.5.3.2 Alternative format</li>
     * <li><a href="http://www.w3.org/TR/xmlschema-2/#isoformats"> W3C XML
     * Schema 1.0 Part 2, Appendix D, ISO 8601 Date and Time Formats</a></li>
     ...
     * {@link java.util.Calendar#DATE} = 1, etc. This is important as there are
     * variations in the Gregorian Calendar, e.g. leap years have different days
     * in the month = {@link java.util.Calendar#FEBRUARY} so the result of
     * {@link Duration#getMonths()} and {@link Duration#getDays()} can be
     * influenced.
     * </p>
     * 
     ...
     * </p>
     * 
     * @return New <code>XMLGregorianCalendar</code> with all date/time datatype
     *         fields set to {@link DatatypeConstants#FIELD_UNDEFINED} or null.
     */
     ...
     * <em>(in minutes)</em></td>
     * <td>{@link XMLGregorianCalendar#setTimezone(int offset)}<sup><em>*</em>
     * </sup></td>
     * </tr>
     * </tbody>
     * </table>
     * <p>
     * <em>*</em>conversion loss of information. It is not possible to represent
     ...
     * <code>java.util.TimeZone</code> with a custom timezone id using the
     * <code>this.getTimezone()</code>.</li>
     ...
     * 
     * <p>
     * A {@link DatatypeConstants#FIELD_UNDEFINED} value indicates that field
     * isnot set.
     * </p>
     * 
     * @param year
     ...
     */
    public XMLGregorianCalendar newXMLGregorianCalendar(final int year, final int month,
	    final int day, final int hour, final int minute, final int second,
	    final int millisecond, final int timezone) {
	return XMLGregorianCalendarImpl.createDateTime(year, month, day, hour, minute, second,
		millisecond, timezone);
    }

    /**
     * <p>
     * Constructor allowing for complete value spaces allowed by W3C XML Schema
     * 1.0 recommendation for xsd:dateTime and related builtin datatypes. Note
     * that <code>year</code> parameter supports arbitrarily large numbers and
     * fractionalSecond has infinite precision.
     * </p>
     * 
     * @param year
     *            of <code>XMLGregorianCalendar</code> to be created.
