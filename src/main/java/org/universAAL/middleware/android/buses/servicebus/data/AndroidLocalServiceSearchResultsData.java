 ...
 * 
 */
public class AndroidLocalServiceSearchResultsData extends AbstractAndroidServiceBusPersistable
	...
	try {
	    ...
	    sqliteMngr.addLocalServicesSearchResultsWithProfiles(id, serializedProfiles);
	} finally {
	    sqliteMngr.close();
	}
    }
	...
	String[] serializedProfiles = localServiceSearchResultRowDB.getProfiles();
