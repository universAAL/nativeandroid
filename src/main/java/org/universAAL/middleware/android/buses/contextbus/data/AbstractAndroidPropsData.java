 ...
 * 
 */
public abstract class AbstractAndroidPropsData extends AbstractAndroidContextBusPersistable
	...
	try {
	    // Query for the container
	    FiltererContainerRowDB rowDB = sqliteMngr.queryForFiltererContainer(key,
		    getContainerType());
	    if (null == rowDB) {
    ...
    protected IAndroidFiltererContainerData createFiltererContainer(FiltererContainerRowDB rowDB) {
    ...
    private Collection<IFiltererContainer> createFiltererContainers(FiltererContainerRowDB[] rowsDB) {
