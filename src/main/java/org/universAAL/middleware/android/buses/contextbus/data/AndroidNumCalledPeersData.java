 ...
 * 
 */
public class AndroidNumCalledPeersData extends AbstractAndroidContextBusPersistable implements
	INumCalledPeersData {
	...
	if (cache.containsKey(messageID)) {
	    ...
	    try {
		// Query from DB
		CalledPeersRowDB calledPeersRow = sqliteMngr.queryForCalledPeers(messageID);
    ...
    private ICalledPeers createCalledPeersFromRow(CalledPeersRowDB calledPeersRowDB) {
