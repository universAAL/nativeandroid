...
public class OntologiesContainedXml implements Serializable {
	...
	Node ontologiesNode = CommonXmlParserUtils.getSingleChildNode(nodeContainsOntologies,
		ICommonXmlConstants.ONTOLOGIES_ELEMENT);

	// Get the ontologies list
	List<Node> ontologiesChileNodes = CommonXmlParserUtils.getChildNodes(ontologiesNode,
		ICommonXmlConstants.ONTOLOGY_ELEMENT);
