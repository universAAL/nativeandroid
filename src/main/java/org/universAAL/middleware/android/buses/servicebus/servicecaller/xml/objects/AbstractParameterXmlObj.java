 ...
 * 
 */
public abstract class AbstractParameterXmlObj extends AbstractPropertiesContainer {
	...
	androidExtraParameter = CommonXmlParserUtils.getAttributeValueAsString(parameterNode,
	...
	javaClass = CommonXmlParserUtils.getAttributeValueAsString(parameterNode,
