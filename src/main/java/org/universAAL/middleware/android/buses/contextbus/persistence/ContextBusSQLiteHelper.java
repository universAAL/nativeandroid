...
public class ContextBusSQLiteHelper extends AbstractCommonBusSQLiteHelper {// SQLiteOpenHelper
    ...
    private static final String[] sqlCommandsOnCreation = new String[] {
	    new RegistryContextsTable().getTableCreateCommand(), AllProvisionsTable.TABLE_CREATE,
	    CalledPeersTable.TABLE_CREATE, ContextEventPatternsTable.TABLE_CREATE,
	    ContextFiltererTable.TABLE_CREATE, FiltererContainerTable.TABLE_CREATE,
	    ProvisionsTable.TABLE_CREATE };
