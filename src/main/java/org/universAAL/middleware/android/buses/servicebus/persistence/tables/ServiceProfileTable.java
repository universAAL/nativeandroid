...
public class ServiceProfileTable {
    ...
    public static final String TABLE_CREATE = "create table if not exists " + TABLE_NAME + "( "
	    + COLUMN_ID_PK + " " + ISqlConstants.AUTO_INCREMENT_PK + ", " + COLUMN_CONTENT
	    + " VARCHAR(200) " + ISqlConstants.NOT_NULL_COLUMN + ", " + COLUMN_SERVICES_ID_FK
	    + " integer, " + "FOREIGN KEY (" + COLUMN_SERVICES_ID_FK + ") REFERENCES "
	    + LocalServiceSearchResultsTable.TABLE_NAME + " ("
	    + LocalServiceSearchResultsTable.COLUMN_ID_PK + ") ON DELETE CASCADE);";
}
